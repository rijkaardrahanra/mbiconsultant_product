            ...
            <input type="hidden" name="idmanmapel" id="idmanmapel" value="<?php echo $idmanmapel->MM_MANAGE_MAPEL_ID;?>">
              ...
              <div class="padded">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" placeholder="Masukkan Bobot Jawaban Benar" class="validate[required,custom[integer]]" id="bobotbenar" name="bobotbenar" maxlength="2" value=""/>
                  </div>
                </div>
              </div>
              <div class="padded">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" placeholder="Masukkan Bobot Jawaban Salah" class="validate[custom[integer]]" id="bobotsalah" name="bobotsalah" value=""/>
                  </div>
                </div>
              </div>
              <div class="padded">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" placeholder="Masukkan Bobot Tidak Jawab" class="validate[custom[integer]]" id="bobottidakjawab" name="bobottidakjawab" value=""/>
                  </div>
                </div>
              </div>
...
$(document).on('click', '#addPertanyaan', function(e){
    ...
    $.ajax({
    url: "<?php echo site_url('DataBankSoal/simpanTambahFromDetail'); ?>",
    type: "POST",
    cache: false,
    data: {question:question,option_a:option_a,option_b:option_b,option_c:option_c,option_d:option_d,option_e:option_e,correct_ans:correct_ans,idmanmapel:idmanmapel,bab_id:bab_id,tingkatsulit:tingkatsulit,bobotbenar:bobotbenar,bobotsalah:bobotsalah,bobottidakjawab:bobottidakjawab,url:url},
    dataType:'json',
