          ...
          <div class="tab-content">
            ...
            ?>
                        <tr>
                        	...
                        	<td class="center">
                            <?php echo complete_tanggal_indo($detailujian->TGL_MULAI_UJIAN).'<br/>('.$detailujian->DURASI_UJIAN_MENIT.' Menit)'; ?>
                            <!-- <div class="col-12">

                            <div class="col-5">
                            </div>
                            <div class="col-4">
                            <a href="#" data-id="<?php echo $detailujian->ID_DETAIL_PAKETUJIAN; ?>" class="btn btn-green btn-small btnEditTgl"><i class="icon-list-ul"></i></a>
                            </div>
                            </div> -->
                          </td>
                          ...
                          <td class="center"><a href="#" data-id="<?php echo $detailujian->ID_DETAIL_PAKETUJIAN; ?>" class="btn <?php echo (($detailujian->DEFAULT_OR_CUSTOM) == '1' ? 'btn-blue' : 'btn-default'); ?> btn-small default"><i class="icon-list-ul"></i> Default</a><?php echo (($detailujian->DEFAULT_OR_CUSTOM) == '1' ? ' <i class="icon-check"></i>' : ''); ?><br/><b>OR</b><br/>
                          <a href="#" data-id="<?php echo $detailujian->ID_DETAIL_PAKETUJIAN; ?>" class="btn <?php echo (($detailujian->DEFAULT_OR_CUSTOM) == '0' ? 'btn-blue' : 'btn-default'); ?> btn-small custom"><i class="icon-list-ul"></i> Custom</a><?php echo (($detailujian->DEFAULT_OR_CUSTOM) == '0' ? ' <i class="icon-check"></i>' : ''); ?>
                          </td>
                        	<td class="center">
