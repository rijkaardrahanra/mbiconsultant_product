      ...
      <div class="box">
          ...
          <ul class="nav nav-tabs nav-tabs-left">
            ...
            <li>
              ...
              <i class="icon-pencil"></i>Edit Klien
               ...
               <li>
              <a href="#daftarsiswa" data-toggle="tab">
              <i class="icon-user"></i>Daftar Siswa Klien
              </a>
            </li>
        ...
        <div class="box-content padded">
          <div class="tab-content">
            ...
            <div class="tab-pane box" id="addpketujian" style="padding: 5px">
              <div class="box-content">
                <form id="formPketUjian" name="formPketUjian" class="form-horizontal validatable" >
                  ...
                  <div class="padded">
                    <div class="control-group">
                      <label class="control-label">Langsung Tampil Hasil</label>
                      <div class="controls">
                        <select name="istampil" id="istampil" class="chzn-select">
            ...
            <div class="tab-pane box" id="daftarsiswa" style="padding: 5px">
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                  <thead>
                    <tr>
                      <th><div>No</div></th>
