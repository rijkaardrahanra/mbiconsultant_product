...
<style type="text/css">
    ...
    #connectloader img, #connectloader2 img
    {
        top:0;
        left:0;
        right:0;
    ...
    #connectloader span, #connectloader2 span, 
    {
        top:75vh;
        left:0;
        right:0;
...
@media screen and (max-width: 767px) {
  ...
  <div class="main-content">
    ...
    <div class="container-fluid padded">
      ...
      <div id="connectloader2" style="top: 0;left: 0;">
