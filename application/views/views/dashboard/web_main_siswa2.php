...
.numbers:hover {
  ...
  <div class="main-content">
    ...
    <div class="container-fluid padded">
      ...
      <div id="element2" style="height: 100%;width: 100%;" >
      <div class="row-fluid">
      <div class="span8">
      <div class="box">
        <div class="box-content padded">
...
$(document).on('click', '.mulai', function(e){
  ...
  if(thisis.is(':checked')){
    ...
    //   alert('Develooper Tools harus di nonaktifkan. Tampilan Hanya Terlihat Untuk Ujian. Selebihnya Dianggap Sebagai Pelanggaran');
    // }else{
      ...
      dataType:'json',
        ...
        success: function(json){
          ...
          if (json.status==1) {
              ...
              text += '<div id="durasiujian" style="color: black !important;">'+durasi+' Menit</div>';
