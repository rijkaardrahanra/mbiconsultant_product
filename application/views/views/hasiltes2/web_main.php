        ...
        <div class="box-content padded">
          <div class="tab-content">
            ...
            <div class="box-content">
              ...
              <form id="FormTheme" name="FormTheme" class="form-horizontal validatable" action="<?php echo base_url(); ?>Hasiltes/index2">
              <div class="padded">
                    ...
                    <div class="controls">
                      <select name="paketujian" id="paketujian" class="chzn-select">
                        ...
                        foreach ($ujian as $ujian) { 
                         ?>
                          <option id="id_pktu_paketujian" name="id_pktu_paketujian" value="<?php echo $ujian->PKTU_PAKETUJIAN_ID; ?>" <?php //if($theme_data->theme_id==$theme->id){ echo 'selected="selected"'; } ?> ><?php echo $ujian->NAMA_UJIAN;?></option>; 
                        
                        <?php } ?>
                      </select>
                       <!-- <button id="btn-tampilkan" class="btn btn-gray">Tampilkan</button> -->
                       <input type="submit" class="btn btn-gray" name="btnSubmit" value="Tampilkan">
                    </div>
                  </div>
                </div>                
              </form>
